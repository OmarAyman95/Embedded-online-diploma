...
#define NVIC_EXTI0      (1U<<6)
#define NVIC_EXTI1      (1U<<7)
#define NVIC_EXTI2      (1U<<8)
#define NVIC_EXTI3      (1U<<9)
#define NVIC_EXTI4      (1U<<10)

#define NVIC_EXTI5_9    (1U<<23)
#define NVIC_EXTI10_15  (1U<<8)
