...
#include "keyPad.h"
//static const char keyPressed[16]={'7','4','1','c','8','5','2','0','9','6','3','=','/','X','-','+'};
static unsigned pressed;
static void KeyPad_Send_Wave(unsigned n,volatile unsigned char  *PORT)
{
	switch(n)
	{
		case 4:
...
static void KeyPad_Waiting(volatile unsigned char  *PORT,unsigned data)
{
